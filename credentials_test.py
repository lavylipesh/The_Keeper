...
class TestCredentials(unittest.TestCase):
    ...
    def test_save_multiple_passwords(self):
        '''
        test to check if we can save multiple passwords
        '''
        self.new_credentials.save_credentials()
    ...
    def test_search_credentials(self):
        ...
        found_credentials = Credentials.search_credentials("pesh")
    ...
    def test_display_credentials(self):
        ...
        #def test_copy_password(self,username):
        #'''
        #test to confirm we are copying the password from a found user account
        #'''
        #self.new_credentials.save_credentials()
